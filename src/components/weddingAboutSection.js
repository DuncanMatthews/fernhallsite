...
const WeddingAboutSection = () => {
  return (
    <div id="about">
      <h2 className="wedding-section-heading">About the Property</h2>
      <div className="iikjzje i10xc1ab dir dir-ltr">
                <div className="i4wvyiy i1fpqhzs dir dir-ltr">
                <svg viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style={{ display: 'block', height: '24px', width: '24px', fill: 'currentcolor' }}>
                ...
                <div className="amenities-icon-text">10 Acres</div>
            </div>
            ...
            <div className="iikjzje i10xc1ab dir dir-ltr">
                ...
                <div className="amenities-icon-text">Outdoor Capacity 100+</div>
            </div>
            <div className="iikjzje i10xc1ab dir dir-ltr">
                <div className="i4wvyiy i1fpqhzs dir dir-ltr">
                <svg viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style={{ display: 'block', height: '24px', width: '24px', fill: 'currentcolor' }}>
                ...
                <div className="amenities-icon-text">Sleeps 28</div>
            </div>
            <div className="iikjzje i10xc1ab dir dir-ltr">
                <div className="i4wvyiy i1fpqhzs dir dir-ltr">
                <svg viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style={{ display: 'block', height: '24px', width: '24px', fill: 'currentcolor' }}>
                ...
                <div className="amenities-icon-text">Indoor Capacity 50+</div>
            </div>
            
      <p className="wedding-section-heading">Fern Hall Estate is truly a hidden gem nestled in the heart of the stunning Endless Mountains. The property&apos;s picturesque location between Crystal Lake and the mountains offers a breathtaking backdrop for your wedding day.

As you and your guests approach the estate, you&apos;ll be greeted by the historic stone house, which exudes elegance and sophistication. The interior is adorned with original bronze sconces and chandeliers by Tiffany, transporting you and your guests to a bygone era of refinement and grace. The preserved bathroom fixtures and windows add to the estate&apos;s charm, and you&apos;ll feel as though you&apos;ve stepped back in time to a more elegant era. <br></br><br></br>

The estate&apos;s private spring-fed lake, complete with its own boathouse, provides a serene and tranquil setting for your special day. Acres of private estate living surrounded by stunning mountain scenery create an idyllic setting for your wedding photography.

The estate&apos;s six wood barns, dating back to the mid-1800s, add to the rustic charm of the property. The barns provide a perfect backdrop for outdoor ceremonies or rustic receptions, with plenty of space to dance the night away under the stars. <br></br><br></br>
...
export default WeddingAboutSection;